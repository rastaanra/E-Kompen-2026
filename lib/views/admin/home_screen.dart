...
class _AdminHomeScreenState extends State<AdminHomeScreen> {
    ...
    onNotifTap: () async {
      ...
      _loadNotif();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildActionCard(
                            ...
                            onTap: () => NavAdmin.toPengajuan(context),
                          ),
                          const SizedBox(height: 12),
                          _buildActionCard(
                            ...
                            onTap: () => NavAdmin.toVerifikasi(context),
                          ),
                          ...
                          subtitle: 'Mahasiswa',
                          onTap: () => NavAdmin.toManagement(context, initialTab: 0),
                        ),
                        ...
                        _buildMenuCard(
                          ...
                          title: 'Management Data',
                          subtitle: 'Dosen',
                          onTap: () => NavAdmin.toManagement(context, initialTab: 1),
                        ),
                        const SizedBox(height: 10),
                        _buildMenuCard(
                          ...
                          subtitle: 'Absensi',
                          onTap: () => NavAdmin.toManagement(context, initialTab: 2),
                        ),
                        ],
                      ),
                    ),
          ...
          AppBottomNavAdmin(
            ...
            onTap: (tab) => NavAdmin.handleBottomNav(context, tab, NavTabAdmin.home),
          ),
        ],
      ),
    );
  ...
  Widget _buildActionCard({
    ...
    final Color iconBg = hasAction
        ? Colors.white.withOpacity(0.2)
        : Colors.white.withOpacity(0.3);
    final Color iconColor =
        hasAction ? Colors.white : const Color(0xFF7A6F65);
    final Color labelColor =
        hasAction ? Colors.white.withOpacity(0.75) : const Color(0xFF8A7F75);
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontWeight:
                          hasAction ? FontWeight.w700 : FontWeight.w600,
                      color: valueColor,
                    ),
                  ),
                ],
