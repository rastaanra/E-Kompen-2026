...
class _ProfileDosenScreenState extends State<ProfileDosenScreen> {
  ...
  Future<void> _loadProfileData() async {
    ...
    final nama = prefs.getString('nama_lengkap') ?? 'Dosen Pengampu';
    final email = prefs.getString('email') ?? 'dosen@jti.com';
      ...
      body: Column(
        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              final updated = await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const EditProfileDosenScreen(),
                                ),
                              );
                              if (updated == true) {
                                _loadProfileData();
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.email_outlined, color: _primaryRed, size: 18),
                          ),
                          ...
                          _buildSettingsTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const ChangePasswordDosenScreen(),
                                ),
                              );
                            },
                          ),
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: const Icon(Icons.notifications_outlined, color: _primaryRed, size: 18),
                                ),
                                const SizedBox(width: 12),
                                const Expanded(
                                  child: Text(
                                ...
                                Switch(
                                  value: _notifEnabled,
                                  onChanged: (val) async {
                                    await SessionManager.setNotifikasiAktif(val);
          ...
          AppBottomNavDosen(
            ...
            onTabSelected: (tab) => NavDosen.handleBottomNav(context, tab, NavTabDosen.profil),
          ),
        ],
      ),
    );
