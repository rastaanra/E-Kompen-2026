...
class ChangePasswordDosenScreen extends StatefulWidget {
  const ChangePasswordDosenScreen({super.key});

  @override
  State<ChangePasswordDosenScreen> createState() => _ChangePasswordDosenScreenState();
}

class _ChangePasswordDosenScreenState extends State<ChangePasswordDosenScreen> {
        ...
        content: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.check_circle_outline, color: Colors.green[700], size: 48),
            ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.info_outline, color: _primaryRed, size: 18),
