...
Future<void> _loadData() async {
  ...
  for (var p in data) {
    print("TUJUAN = ${p.kodeTtdTujuan}");
    print("KAPRODI = ${p.kodeTtdKaprodi}");
  }
  ...
  List<PengajuanKompen> get _filteredList {
    ...
    filtered.sort((a, b) {
      if (a.status == 'menunggu_ttd_kaprodi' &&
          b.status == 'selesai') {
        return -1;
      }

      if (a.status == 'selesai' &&
          b.status == 'menunggu_ttd_kaprodi') {
        return 1;
      }
  ...
  void _showFormVerifikasi(PengajuanKompen p) {
    showModalBottomSheet(
      ...
      builder: (ctx) {
        ...
        final bool TujuanSudahTtd =
        p.kodeTtdTujuan != null && p.kodeTtdTujuan!.isNotEmpty;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: p.kodeTtdKaprodi != null
                                      ? QrImageView(
                                          data: p.kodeTtdKaprodi!,
                                          version: QrVersions.auto,
                                          size: 100,
                                        )
                                      : Text(
