...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  String get inisialMahasiswa {
    if (namaMahasiswa.isEmpty) return 'MH';

    final parts = namaMahasiswa.trim().split(' ');
  ...
  Future<void> _loadUser() async {
    ...
    // Buka shared preferences secara langsung untuk mengambil nim & program_studi
    final prefs = await SharedPreferences.getInstance();
    final nimUser = prefs.getString('nim');
    final prodiUser = prefs.getString('program_studi');
  ...
  // Ambil gambar dari kamera/galeri lalu kirim ke API backend
  ...
  // Menu Bottom Sheet pilihan ganti foto
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const Text('Mahasiswa Aktif', style: TextStyle(fontSize: 11, color: _primaryRed, fontWeight: FontWeight.w500)),
                ]),
              ),
            ]),
          ),
